...
Alt_ind::Alt_ind(float x, float y, float z) {
    ...
    vertex_buffer_data_stick[0] = -5.0f;
    vertex_buffer_data_stick[1] = 0.0f;
    vertex_buffer_data_stick[2] = 0.0f;
    vertex_buffer_data_stick[3] = 5.0f;
    vertex_buffer_data_stick[4] = 0.0f;
    vertex_buffer_data_stick[5] = 0.0f;
    vertex_buffer_data_stick[6] = 0.0f;
...
void Alt_ind::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}
