...
Speed_ind::Speed_ind(float x, float y, float z, color_t color) {
...
void Speed_ind::draw(glm::mat4 VP, float speed) {
    ...
    glm::mat4 rotate = glm::rotate(-glm::radians(speed*180/2000), glm::vec3(0, 0, 1));
...
void Speed_ind::set_position(float x, float y, float z) {
    this->position = glm::vec3(x, y, z);
}
